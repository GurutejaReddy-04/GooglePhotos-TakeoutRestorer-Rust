...
> - **Verified by audit:** The build, formatting, linting, and testing commands below have been independently verified to execute cleanly across the entire workspace on v0.1.9.
